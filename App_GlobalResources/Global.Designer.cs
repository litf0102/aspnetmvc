...
namespace Resources {
    ...
    internal class Global {
        ...
        /// <summary>
        ///   jQuery&amp;Ajax验证 に類似したローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   ASP.NET是一个使用HTML，CSS和JavaScript构建大型网站和Web应用程序的免费Web框架。 に類似したローカライズされた文字列を検索します。
        /// </summary>
